...
/**
 * @brief Inserisce un messaggio nella coda dei messaggi.
 * 
...
/**
 * @brief Esegue un'operazione sul semaforo specificato.
 * 
 ...
 *               -1 per operazione P (wait), 
 *               +1 per operazione V (signal), 
 *                0 per attendere che il semaforo sia zero.
 */
...
/**
 * @brief Funzione principale del processo "direttore".
 * 
 * @param semWaitInit Semaforo per la sincronizzazione dell'inizializzazione dei processi.
 * @param shm_id ID della memoria condivisa per la struttura Config.
 * @param shm_id_StatsDay ID della memoria condivisa per la struttura StatsDay.
 * @param shm_id_StatsSim ID della memoria condivisa per la struttura StatsSim.
 ...
 * @param explode Puntatore a variabile booleana per la simulazione di un’esplosione.
 */
...
/**
 * @brief Carica i parametri di configurazione da un file.
 * 
...
/**
 * @brief Esegue il ciclo operativo di un lavoratore nel sistema simulato.
 * 
 * @param semLavoratore Semaforo per la sincronizzazione del lavoratore.
 * @param i Indice identificativo del lavoratore.
 * @param tipoLavoro Tipo di lavoro assegnato (servizio).
 ...
 * @param nofPause Numero di pause disponibili per il lavoratore.
 * @param statsDay Puntatore alla struttura StatsDay condivisa.
 * @param statsSim Puntatore alla struttura StatsSim condivisa.
...
/**
 * @brief Stampa le statistiche giornaliere su un file CSV.
 * 
 * @param shared_memory Puntatore alla struttura Config condivisa.
 * @param statsDay Puntatore alla struttura StatsDay contenente i dati giornalieri.
 * @param csv Puntatore al file CSV di output.
 * @param count_sportelli Array contenente il numero di sportelli per servizio.
 * @param count_operatori Array contenente il numero di operatori per servizio.
...
/**
 * @brief Stampa le statistiche complessive della simulazione su un file CSV.
 * 
 ...
 * @param gg Numero totale di giorni simulati.
 */
